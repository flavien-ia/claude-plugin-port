 ...
 */
export function buildOpencode({ srcDir, files, src, fsx, opts, log, warnings, generator }) {
  ...
  log(`- ${src.skillNames.length} skills, ${converted.files.length} files; each skill is also a /command`);
